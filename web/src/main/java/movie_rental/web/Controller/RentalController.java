...
import movie_rental.core.Service.RentalService;
...
public class RentalController {
    ...
    public RentalDto rent(@RequestBody RentalDto rentalDto) {
        log.trace("rent - method entered");
        RentalDto result = rentalConverter.convertModelToDto(
                rentalService.rent(rentalDto.getClient().getId(),rentalDto.getMovie().getId(),rentalDto.getDate()));
    ...
    public RentalDto updateRental(@PathVariable long id, @RequestBody RentalDto rentalDto) {
        ...
        RentalDto result = rentalConverter.convertModelToDto(
                rentalService.updateRent(id, rentalConverter.convertDtoToModel(rentalDto)));
